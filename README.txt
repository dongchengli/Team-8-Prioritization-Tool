...
Open the pom.xml file inside the test program then add “dependencies”
...
Also add the “plugins” to pom.xml file
*******************************************************************************************************************
...
First make two copies of the current pom.xml file, one for Total Strategy and one for Additional strategy, rename them according to “pom_test_AS.xml” for Additional strategy and “pom_test_TS.xml” for Total strategy. 
